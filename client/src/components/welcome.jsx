           ...
           <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className= "flex flex-1 jusitfy-start flex-col mf:mr-10">
                    ...
                    <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                        <div className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-71 w-full my-5 eth-card white-glassmorphism">
                            <div className="flex justify-between flex-co w-full h-full">
